...
#%%
#try to make it move to the next card
# for i in len(mtg_cards_in_page):
#     mtg_card = driver.find_element_by_xpath('//*[contains(@id, "cardTitle")]').text
#     print(mtg_card)
#     i += 1
#card_img_url = card.find_element_by_xpath('/img').get_attribute('src')
#//*[@id="ctl00_ctl00_ctl00_MainContent_SubContent_SubContent_ctl00_listRepeater_ctl01_cardTitle"]
#//*[@id="ctl00_ctl00_ctl00_MainContent_SubContent_SubContent_searchResultsContainer"]/div/table/tbody/tr/td/table[1]
#//*[@id="ctl00_ctl00_ctl00_MainContent_SubContent_SubContent_searchResultsContainer"]/div/table/tbody/tr/td/table[2]
